...
echo "" >> /home/$user/hardware-info.txt
) | sudo -H env DISPLAY=:0 zenity --progress --pulsate --width 350 --window-icon "/usr/share/pixmaps/regataos-support.png" --text "Collecting hardware information..." --title "Hardware information" --auto-close --auto-kill --no-cancel
